<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="User _Login.aspx.cs" Inherits="Carr.User_Login" %>
    ...
    <form id="form1" runat="server">
        <div class="container">
            ...
            <div class="footer-links">
                ...
                <asp:LinkButton ID="r_btn" runat="server">
                    <a href="User_Ragister.aspx">
                    Register
                        </a>
                </asp:LinkButton>
                <br />
                <br />
                <a href="./Admin/Admin_Login.aspx">Admin Login</a>
            </div>
        </div>
    </form>
